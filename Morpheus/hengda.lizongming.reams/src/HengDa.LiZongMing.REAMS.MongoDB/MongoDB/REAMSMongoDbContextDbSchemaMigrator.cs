...
{
    public class REAMSMongoDbContextDbSchemaMigrator : HengDa.LiZongMing.REAMS.Data.IREAMSDbSchemaMigrator, ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public REAMSMongoDbContextDbSchemaMigrator(IServiceProvider serviceProvider)
        {
