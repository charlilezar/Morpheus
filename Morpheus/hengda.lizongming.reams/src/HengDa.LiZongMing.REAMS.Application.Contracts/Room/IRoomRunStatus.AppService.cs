...
namespace HengDa.LiZongMing.REAMS.Room
{
    ...
    public partial interface IRoomRunStatusAppService : ICrudAppService<RoomRunStatusDto, Guid, RoomRunStatusPagedRequest, RoomRunStatusDto, RoomRunStatusDto>
    {
        ...
        /// <returns></returns>
        //Task<RoomRunStatusDto> GetOrNew(Guid? input);
