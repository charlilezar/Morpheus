...
namespace HengDa.LiZongMing.REAMS.NaI
{
    ...
    public partial interface INaiRecordAppService : ICrudAppService<NaiRecordDto, Guid, NaiRecordPagedRequest, NaiRecordDto, NaiRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<NaiRecordDto> GetOrNew(Guid? input);
