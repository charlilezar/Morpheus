...
namespace HengDa.LiZongMing.REAMS.ZCQ
{
    ...
    public partial interface IZcqRunStatusAppService : ICrudAppService<ZcqRunStatusDto, Guid, ZcqRunStatusPagedRequest, ZcqRunStatusDto, ZcqRunStatusDto>
    {
        ...
        /// <returns></returns>
        //Task<ZcqRunStatusDto> GetOrNew(Guid? input);
