...
namespace HengDa.LiZongMing.REAMS.ZCQ
{
    ...
    public partial interface IZcqRecordAppService : ICrudAppService<ZcqRecordDto, Guid, ZcqRecordPagedRequest, ZcqRecordDto, ZcqRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<ZcqRecordDto> GetOrNew(Guid? input);
