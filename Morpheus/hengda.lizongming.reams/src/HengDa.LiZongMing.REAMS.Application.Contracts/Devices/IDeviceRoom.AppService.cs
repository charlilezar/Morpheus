...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public partial interface IDeviceRoomAppService : ICrudAppService<DeviceRoomDto, long, DeviceRoomPagedRequest, DeviceRoomDto, DeviceRoomDto>
    {
        ...
        /// <returns></returns>
        //Task<DeviceRoomDto> GetOrNew(long? input);
