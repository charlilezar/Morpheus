...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public partial interface IIotDeviceAlarmAppService : ICrudAppService<IotDeviceAlarmDto, Guid, IotDeviceAlarmPagedRequest, IotDeviceAlarmDto, IotDeviceAlarmDto>
    {
        ...
        /// <returns></returns>
        //Task<IotDeviceAlarmDto> GetOrNew(Guid? input);
