...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public partial interface IIotDeviceLogAppService : ICrudAppService<IotDeviceLogDto, Guid, IotDeviceLogPagedRequest, IotDeviceLogDto, IotDeviceLogDto>
    {
        ...
        /// <returns></returns>
        //Task<IotDeviceLogDto> GetOrNew(Guid? input);
