...
namespace HengDa.LiZongMing.REAMS.Authorization
{
    public partial class REAMSPermissions
	{
		...
		///</summary>
		public static partial class AtmosphereRecord
        {
            /// <summary>
            /// IotDeviceShare权限节点
            ///</summary>
            public const string Default = GroupName + ".AtmosphereRecord";


		    /// <summary>
		    /// AtmosphereRecord查询授权
		    ///</summary>
		    public const string Query = Default + ".Query";

		    /// <summary>
		    /// AtmosphereRecord创建权限
		    ///</summary>
		    public const string Create = Default + ".Create";

		    /// <summary>
		    /// AtmosphereRecord修改权限
		    ///</summary>
		    public const string Edit = Default + ".Edit";

		    /// <summary>
		    /// AtmosphereRecord删除权限
		    ///</summary>
		    public const string Delete = Default + ".Delete";

            /// <summary>
		    /// AtmosphereRecord批量删除权限
		    ///</summary>
		    public const string BatchDelete = Default + ".BatchDelete";

		    /// <summary>
		    /// AtmosphereRecord导出Excel
		    ///</summary>
