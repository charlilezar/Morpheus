...
namespace HengDa.LiZongMing.REAMS.Authorization
{
    public partial class REAMSPermissions
	{
		...
		///</summary>
		public static partial class HighVoltageElectrometerExtRecord
        {
            /// <summary>
            /// IotDeviceShare权限节点
            ///</summary>
            public const string Default = GroupName + ".HighVoltageElectrometerExtRecord";


		    /// <summary>
		    /// HighVoltageElectrometerExtRecord查询授权
		    ///</summary>
		    public const string Query = Default + ".Query";

		    /// <summary>
		    /// HighVoltageElectrometerExtRecord创建权限
		    ///</summary>
		    public const string Create = Default + ".Create";

		    /// <summary>
		    /// HighVoltageElectrometerExtRecord修改权限
		    ///</summary>
		    public const string Edit = Default + ".Edit";

		    /// <summary>
		    /// HighVoltageElectrometerExtRecord删除权限
		    ///</summary>
		    public const string Delete = Default + ".Delete";

            /// <summary>
		    /// HighVoltageElectrometerExtRecord批量删除权限
		    ///</summary>
		    public const string BatchDelete = Default + ".BatchDelete";

		    /// <summary>
		    /// HighVoltageElectrometerExtRecord导出Excel
		    ///</summary>
