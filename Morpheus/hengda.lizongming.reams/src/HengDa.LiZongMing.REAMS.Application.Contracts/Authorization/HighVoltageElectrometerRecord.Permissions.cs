...
namespace HengDa.LiZongMing.REAMS.Authorization
{
    public partial class REAMSPermissions
	{
		...
		///</summary>
		public static partial class HighVoltageElectrometerRecord
        {
            /// <summary>
            /// IotDeviceShare权限节点
            ///</summary>
            public const string Default = GroupName + ".HighVoltageElectrometerRecord";


		    /// <summary>
		    /// HighVoltageElectrometerRecord查询授权
		    ///</summary>
		    public const string Query = Default + ".Query";

		    /// <summary>
		    /// HighVoltageElectrometerRecord创建权限
		    ///</summary>
		    public const string Create = Default + ".Create";

		    /// <summary>
		    /// HighVoltageElectrometerRecord修改权限
		    ///</summary>
		    public const string Edit = Default + ".Edit";

		    /// <summary>
		    /// HighVoltageElectrometerRecord删除权限
		    ///</summary>
		    public const string Delete = Default + ".Delete";

            /// <summary>
		    /// HighVoltageElectrometerRecord批量删除权限
		    ///</summary>
		    public const string BatchDelete = Default + ".BatchDelete";

		    /// <summary>
		    /// HighVoltageElectrometerRecord导出Excel
		    ///</summary>
