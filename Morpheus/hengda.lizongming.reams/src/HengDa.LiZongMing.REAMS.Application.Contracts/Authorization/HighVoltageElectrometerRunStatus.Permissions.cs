...
namespace HengDa.LiZongMing.REAMS.Authorization
{
    public partial class REAMSPermissions
	{
		...
		///</summary>
		public static partial class HighVoltageElectrometerRunStatus
        {
            /// <summary>
            /// IotDeviceShare权限节点
            ///</summary>
            public const string Default = GroupName + ".HighVoltageElectrometerRunStatus";


		    /// <summary>
		    /// HighVoltageElectrometerRunStatus查询授权
		    ///</summary>
		    public const string Query = Default + ".Query";

		    /// <summary>
		    /// HighVoltageElectrometerRunStatus创建权限
		    ///</summary>
		    public const string Create = Default + ".Create";

		    /// <summary>
		    /// HighVoltageElectrometerRunStatus修改权限
		    ///</summary>
		    public const string Edit = Default + ".Edit";

		    /// <summary>
		    /// HighVoltageElectrometerRunStatus删除权限
		    ///</summary>
		    public const string Delete = Default + ".Delete";

            /// <summary>
		    /// HighVoltageElectrometerRunStatus批量删除权限
		    ///</summary>
		    public const string BatchDelete = Default + ".BatchDelete";

		    /// <summary>
		    /// HighVoltageElectrometerRunStatus导出Excel
		    ///</summary>
