...
namespace HengDa.LiZongMing.REAMS.HVE
{
    ...
    public partial interface IHveExtRecordAppService : ICrudAppService<HveExtRecordDto, Guid, HveExtRecordPagedRequest, HveExtRecordDto, HveExtRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<HveExtRecordDto> GetOrNew(Guid? input);
