...
namespace HengDa.LiZongMing.REAMS.HVE
{
    ...
    public partial interface IHveRecordAppService : ICrudAppService<HveRecordDto, Guid, HveRecordPagedRequest, HveRecordDto, HveRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<HveRecordDto> GetOrNew(Guid? input);
