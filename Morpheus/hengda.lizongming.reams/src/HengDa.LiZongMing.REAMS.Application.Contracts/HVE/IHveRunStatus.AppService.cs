...
namespace HengDa.LiZongMing.REAMS.HVE
{
    ...
    public partial interface IHveRunStatusAppService : ICrudAppService<HveRunStatusDto, Guid, HveRunStatusPagedRequest, HveRunStatusDto, HveRunStatusDto>
    {
        ...
        /// <returns></returns>
        //Task<HveRunStatusDto> GetOrNew(Guid? input);
