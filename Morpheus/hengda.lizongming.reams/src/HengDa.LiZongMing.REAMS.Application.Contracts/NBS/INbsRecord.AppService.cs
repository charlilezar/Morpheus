...
namespace HengDa.LiZongMing.REAMS.NBS
{
    ...
    public partial interface INbsRecordAppService : ICrudAppService<NbsRecordDto, Guid, NbsRecordPagedRequest, NbsRecordDto, NbsRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<NbsRecordDto> GetOrNew(Guid? input);
