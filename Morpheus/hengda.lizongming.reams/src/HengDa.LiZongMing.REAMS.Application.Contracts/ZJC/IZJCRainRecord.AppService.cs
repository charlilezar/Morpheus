...
namespace HengDa.LiZongMing.REAMS.ZJC
{
    ...
    public partial interface IZjcRainRecordAppService : ICrudAppService<ZjcRainRecordDto, Guid, ZjcRainRecordPagedRequest, ZjcRainRecordDto, ZjcRainRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<ZjcRainRecordDto> GetOrNew(Guid? input);
