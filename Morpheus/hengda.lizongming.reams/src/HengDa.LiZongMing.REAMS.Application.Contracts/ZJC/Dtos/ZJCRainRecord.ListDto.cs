...
public partial class ZjcRainRecordListDto : EntityDto<Guid>
    {
        #region 构造方法
        public ZjcRainRecordListDto()
        {
        }
        #endregion
