...
namespace HengDa.LiZongMing.REAMS.ZJC
{
    ...
    public partial interface IZjcRunStatusAppService : ICrudAppService<ZjcRunStatusDto, Guid, ZjcRunStatusPagedRequest, ZjcRunStatusDto, ZjcRunStatusDto>
    {
        ...
        /// <returns></returns>
        //Task<ZjcRunStatusDto> GetOrNew(Guid? input);
