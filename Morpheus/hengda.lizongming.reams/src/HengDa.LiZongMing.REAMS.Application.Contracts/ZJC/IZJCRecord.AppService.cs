...
namespace HengDa.LiZongMing.REAMS.ZJC
{
    ...
    public partial interface IZjcRecordAppService : ICrudAppService<ZjcRecordDto, Guid, ZjcRecordPagedRequest, ZjcRecordDto, ZjcRecordDto>
    {
        ...
        /// <returns></returns>
        //Task<ZjcRecordDto> GetOrNew(Guid? input);
