...
{
    public class NaIBaseDto : BaseDto
    {
        [Description("命令值")]
        public HDNaISCmdCode Cmd { get; set; }
    }
    #region 实时数据
    public class NaIRealDataDto : NaIBaseDto
    {
        public NaIRealDataDto()
        {

        }
        public NaIRealDataDto(byte[] data, HDNaISCmdCode cmd)
        {
            try
            {
                this.Cmd = cmd;
                if (data.Length == 26 && 0xEF == data[0] && 0xEF == data[1])
                {
                    this.Sucessfully = true;
                    var getValidata = StringHelper.GetSub(data, 20 , 4);
                    var getDoseRateInt = StringHelper.BitToInt(getValidata);
                    this.DoseRate = getDoseRateInt;
                    this.DoseRateXML = $"<xml><node>{ this.DoseRate }</node></xml>";
                }
                else
                {
        ...
        [Description("剂量率xml")]
        public string DoseRateXML { get; set; }
        #endregion
    }
    #endregion
    #region 索引日期设置反馈结果
    public class NaIRainDetailSearchDateSetDto : NaIBaseDto
    {
        public NaIRainDetailSearchDateSetDto()
        {

        }
        public NaIRainDetailSearchDateSetDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            if (data.Length == 8)
    ...
    /// 索引日期内查询的降雨数据
    /// </summary>
    public class NaIRainDataDto : NaIBaseDto
    {
        public NaIRainDataDto()
        {

        }
        public NaIRainDataDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            /*************
    ...
    /// 索引日期内查询的干沉降数据
    /// </summary>
    public class NaIDryDepositionDataDto : NaIBaseDto
    {
        public NaIDryDepositionDataDto()
        {

        }
        public NaIDryDepositionDataDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            /********
    ...
    #endregion
    #region 故障索引日期设置反馈结果
    public class NaIAlarmSearchDateSetDto : NaIBaseDto
    {
        public NaIAlarmSearchDateSetDto()
        {

        }
        public NaIAlarmSearchDateSetDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            if (data.Length == 8)
    ...
    #endregion
    #region 故障查询结果数
    public class NaIAlarmDataDto : NaIBaseDto
    {
        public NaIAlarmDataDto()
        {

        }
        public NaIAlarmDataDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            /*************
    ...
    public class NaIRainDetailStartIndexSetDto : NaIBaseDto
    {
        public NaIRainDetailStartIndexSetDto()
        {

        }
        public NaIRainDetailStartIndexSetDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            if (data.Length == 8)
    ...
    public class NaIDryDepDetailStartIndexSetDto : NaIBaseDto
    {
        public NaIDryDepDetailStartIndexSetDto()
        {

        }
        public NaIDryDepDetailStartIndexSetDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            this.MacNo = iMacNo;
            this.Cmd = cmd;
            if (data.Length == 8)
    ...
    #endregion
    #region 自定义地址查询
    public class NaICustomAdrDto : NaIBaseDto
    {
        public NaICustomAdrDto()
        {

        }
        public NaICustomAdrDto(byte[] data, HDNaISCmdCode cmd, ushort iMacNo)
        {
            /***********
    ...
    #region 文件查询反馈
    public class NaIFileInfoDto : NaIBaseDto
    {
        public NaIFileInfoDto()
        {
            this.Title = "文件信息";
        }
        public NaIFileInfoDto(byte[] receiveData, HDNaISCmdCode cmd)
        {
            this.Cmd = cmd;
            this.Title = "文件信息";
