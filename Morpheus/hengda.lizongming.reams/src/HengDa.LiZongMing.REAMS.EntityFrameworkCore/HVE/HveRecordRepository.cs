...
namespace HengDa.LiZongMing.REAMS.HVE
{
    ...
    public class HveRecordRepository : EfCoreRepository<IREAMSDbContext, HveRecord, Guid>, IHveRecordRepository
    {

        public HveRecordRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
