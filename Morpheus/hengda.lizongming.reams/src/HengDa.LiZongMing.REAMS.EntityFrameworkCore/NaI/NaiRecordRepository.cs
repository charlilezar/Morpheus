...
namespace HengDa.LiZongMing.REAMS.NaI
{
    ...
    public class NaiRecordRepository : EfCoreRepository<IREAMSDbContext, NaiRecord, Guid>, INaiRecordRepository
    {

        public NaiRecordRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
