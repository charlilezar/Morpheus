...
namespace HengDa.LiZongMing.REAMS.NBS
{
    ...
    public class NbsRunStatusRepository : EfCoreRepository<IREAMSDbContext, NbsRunStatus, Guid>, INbsRunStatusRepository
    {

        public NbsRunStatusRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
