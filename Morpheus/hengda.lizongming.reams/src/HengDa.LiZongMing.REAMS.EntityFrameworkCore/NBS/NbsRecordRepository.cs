...
namespace HengDa.LiZongMing.REAMS.NBS
{
    ...
    public class NbsRecordRepository : EfCoreRepository<IREAMSDbContext, NbsRecord, Guid>, INbsRecordRepository
    {

        public NbsRecordRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
