...
namespace HengDa.LiZongMing.REAMS.ZJC
{
    ...
    public class ZjcRecordRepository : EfCoreRepository<IREAMSDbContext, ZjcRecord, Guid>, IZjcRecordRepository
    {

        public ZjcRecordRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
