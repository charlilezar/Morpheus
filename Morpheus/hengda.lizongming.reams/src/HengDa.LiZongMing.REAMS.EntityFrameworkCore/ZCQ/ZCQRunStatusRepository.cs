...
namespace HengDa.LiZongMing.REAMS.ZCQ
{
    ...
    public class ZcqRunStatusRepository : EfCoreRepository<IREAMSDbContext, ZcqRunStatus, Guid>, IZcqRunStatusRepository
    {

        public ZcqRunStatusRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
