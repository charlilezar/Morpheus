...
namespace HengDa.LiZongMing.REAMS.ZCQ
{
    ...
    public class ZcqRecordRepository : EfCoreRepository<IREAMSDbContext, ZcqRecord, Guid>, IZcqRecordRepository
    {

        public ZcqRecordRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
