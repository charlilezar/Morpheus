...
namespace HengDa.LiZongMing.REAMS.Crm
{
    ...
    public class CustomerRepository : EfCoreRepository<IREAMSDbContext, Customer, Guid>, ICustomerRepository
    {

        public CustomerRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
