...
namespace HengDa.LiZongMing.REAMS.DLL
{
    ...
    public class DllSettingRepository : EfCoreRepository<IREAMSDbContext, DllSetting, Guid>, IDllSettingRepository
    {

        public DllSettingRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
