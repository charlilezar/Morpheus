...
namespace HengDa.LiZongMing.REAMS.DLL
{
    ...
    public class DllRecordRepository : EfCoreRepository<IREAMSDbContext, DllRecord, Guid>, IDllRecordRepository
    {

        public DllRecordRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
