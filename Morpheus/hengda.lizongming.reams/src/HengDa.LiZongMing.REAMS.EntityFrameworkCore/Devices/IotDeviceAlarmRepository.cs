...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public class IotDeviceAlarmRepository : EfCoreRepository<IREAMSDbContext, IotDeviceAlarm, Guid>, IIotDeviceAlarmRepository
    {

        public IotDeviceAlarmRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
