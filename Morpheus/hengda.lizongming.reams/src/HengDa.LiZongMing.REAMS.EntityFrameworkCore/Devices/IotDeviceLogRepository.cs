...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public class IotDeviceLogRepository : EfCoreRepository<IREAMSDbContext, IotDeviceLog, Guid>, IIotDeviceLogRepository
    {

        public IotDeviceLogRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
