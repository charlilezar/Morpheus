...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public class DeviceRoomRepository : EfCoreRepository<IREAMSDbContext, DeviceRoom, long>, IDeviceRoomRepository
    {

        public DeviceRoomRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
