...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    public class DeviceRepository : EfCoreRepository<IREAMSDbContext, Device, long>, IDeviceRepository
    {

        public DeviceRepository(IDbContextProvider<IREAMSDbContext> dbContextProvider)
