...
namespace HengDa.LiZongMing.REAMS.ZJC
{
    ...
    [Table(REAMSDbProperties.DbTablePrefix + "ZjcRunStatus")]
    public partial class ZjcRunStatus : Entity<Guid>, IHasCreationTime, IMultiTenant  // Entity<Guid> , IHasCreationTime, IHasModificationTime, IExtendableObject, IMustHaveTenant, IContent, IReadPiont, ISeo
    {
        #region 构造方法
        public ZjcRunStatus()
        {
        ...
        #region 构造方法Guid
        public ZjcRunStatus(Guid id) : base(id)
        {
        }
        #endregion
