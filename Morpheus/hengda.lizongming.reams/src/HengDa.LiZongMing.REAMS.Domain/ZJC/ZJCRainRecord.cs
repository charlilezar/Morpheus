...
namespace HengDa.LiZongMing.REAMS.ZJC
{
    ...
    [Table(REAMSDbProperties.DbTablePrefix + "ZjcRainRecord")]
    public partial class ZjcRainRecord : Entity<Guid>, IHasCreationTime, IMultiTenant  // Entity<Guid> , IHasCreationTime, IHasModificationTime, IExtendableObject, IMustHaveTenant, IContent, IReadPiont, ISeo
    {
        #region 构造方法
        public ZjcRainRecord()
        {
        }
        #endregion
        ...
        #region 构造方法Guid
        public ZjcRainRecord(Guid id) : base(id)
        {
        }
        #endregion
