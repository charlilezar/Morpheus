...
namespace HengDa.LiZongMing.REAMS.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update REAMSDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update REAMSEfCoreEntityExtensionMappings to extend the IdentityUser entity
