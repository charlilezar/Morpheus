...
namespace HengDa.LiZongMing.REAMS.Atm
{
    ...
    [Table(REAMSDbProperties.DbTablePrefix + "AtmosphereRecord")]
    public partial class AtmosphereRecord : Entity<Guid>, IHasCreationTime, IMultiTenant  // Entity<Guid> , IHasCreationTime, IHasModificationTime, IExtendableObject, IMustHaveTenant, IContent, IReadPiont, ISeo
    {
        #region 构造方法
        ...
        #region 构造方法Guid
        public AtmosphereRecord(Guid id) : base(id)
        {
        }
        #endregion
