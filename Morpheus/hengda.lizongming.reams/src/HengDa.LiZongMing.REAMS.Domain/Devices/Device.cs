...
namespace HengDa.LiZongMing.REAMS.Devices
{
    ...
    [Table(REAMSDbProperties.DbTablePrefix + "Device")]
    public partial class Device : FullAuditedEntity<long>, IMultiTenant  // Entity<long> , IHasCreationTime, IHasModificationTime, IExtendableObject, IMustHaveTenant, IContent, IReadPiont, ISeo
    {
        #region 构造方法
        public Device()
        {
