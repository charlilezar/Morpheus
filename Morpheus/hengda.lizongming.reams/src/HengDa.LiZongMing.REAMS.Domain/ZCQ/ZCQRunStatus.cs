...
namespace HengDa.LiZongMing.REAMS.ZCQ
{
    ...
    [Table(REAMSDbProperties.DbTablePrefix + "ZcqRunStatus")]
    public partial class ZcqRunStatus : Entity<Guid>, IHasCreationTime, IMultiTenant  // Entity<Guid> , IHasCreationTime, IHasModificationTime, IExtendableObject, IMustHaveTenant, IContent, IReadPiont, ISeo
    {
        #region 构造方法
        public ZcqRunStatus()
        {
        ...
        #region 构造方法Guid
        public ZcqRunStatus(Guid id) : base(id)
        {
        }
        #endregion
